...
public class MapSelectScreen implements Screen {
    ...
    public MapSelectScreen (RoboRally switcher, MainGame mainGame) {
    ...
    public void show() {
        ...
        playerCount.setWidth(width*0.33f);
        playerCount.setHeight(height*0.04f);
        playerCount.setX(alignToAxisX - playerCount.getWidth()/2);
        playerCount.setY(height - playerCount.getHeight() - height*0.39f);
        ...
        chess.setY(height - chess.getHeight()-height*0.45f);
        ...
        dizzy.setY(height - dizzy.getHeight()-height*0.55f);
        ...
        exchange.setY(height - exchange.getHeight()-height*0.60f);
        ...
        backButton.setY(height - backButton.getHeight()-height*0.75f);
